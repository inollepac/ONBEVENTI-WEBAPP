...
export const EventsList: React.FC<EventsListProps> = ({ events, onBack, onCreateClick, onEventClick }) => {
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <h1 className="text-2xl font-black text-gray-900">📅 Sezione ONBEVENTI</h1>
        <p className="text-gray-500 mt-1">Gestisci qui i tuoi eventi standard, separati dagli ONBEDAY.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        {events.length === 0 ? (
          <div className="p-20 text-center text-gray-400">
            ...
            <p className="font-medium">Nessun evento registrato. Crea il primo!</p>
          </div>
        ) : (
